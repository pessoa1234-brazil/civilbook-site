...
async function renderCronograma(param) {
  ...
  app.innerHTML = `
    <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap">
      ...
      <button class="btn" onclick="typeof ASSIST!=='undefined'&&ASSIST.abrirCom('cronograma')" title="Abrir o assessor já sabendo que você está no Cronograma (f40)"><i class="ti ti-sparkles" aria-hidden="true"></i> Perguntar à IA</button>
    </div>
