...
function perguntarInteracaoIA(a, b) {
  ...
  if (typeof ASSIST === "undefined") { if (typeof toast === "function") toast("Assessor indisponível.", "warn"); return; }
  ASSIST.abrirCom("interacoes", `O usuário está na tela Interação entre materiais e consultou o par "${na} × ${nb}", que NÃO consta na base curada do módulo.`, pergunta);
}
