...
const BIBLIO = {
  ...
  // download-inline: os DOIS chamadores (abrirCitacao e bibAbrir, js/conteudo.js) entregam esta URL ao
  // PDFV.abrir → pdf.js, que LÊ os bytes da URL e desenha a página no visualizador do app. Com
  // `{ download }` o Storage manda Content-Disposition: attachment e o PDF vira arquivo salvo em vez de
  // abrir na página — o contrário do que esta tela faz. Exceção declarada em tests/download-arquivo.check.mjs.
