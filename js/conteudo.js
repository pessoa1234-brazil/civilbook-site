...
function paneBiblioteca() {
  ...
  pane.innerHTML = `
    <div class="bib-toolbar">
      ...
      <button class="btn" onclick="typeof ASSIST!=='undefined'&&ASSIST.abrirCom('biblioteca')" title="Abrir o assessor já sabendo que você está na Biblioteca (f40)"><i class="ti ti-sparkles" aria-hidden="true"></i> Perguntar à IA</button>
    </div>
