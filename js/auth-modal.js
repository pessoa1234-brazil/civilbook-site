...
window.cbAuthModalHTML = `
    ...
    <div class="logo" style="justify-content:center;margin-bottom:18px">
      <img class="logo-icon" src="icon.svg" alt="Civilbook"><span>Civilbook</span>
    </div>
    ...
    <form id="form-cadastro" class="hidden" onsubmit="return fazerCadastro(event)">
      ...
      <div class="field"><label>Senha (mínimo 8 caracteres)</label><input type="password" id="c-senha" minlength="8" required></div>
      <div class="field-row">
        <div class="field">
